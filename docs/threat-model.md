...
Before any public deployment: expiring/revocable sessions, Auth.js integration, request/mission rate limits, retention/reset, HTTPS, CSP, explicit CORS policy if origins split, and dependency scanning.
